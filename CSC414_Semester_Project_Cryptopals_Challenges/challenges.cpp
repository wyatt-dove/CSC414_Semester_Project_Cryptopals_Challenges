...
void challenge1()
{
 //the given input hex string
    string input = "49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d";

    //decode the hex-encoded input
    vector<unsigned char> bytes = hexDecode(input);

    //encode the bytes to base64
    string b64Output = b64Encode(bytes);

    //output the resulting string
    cout << "\nChallenge 1: Hex to Base64" << endl;         //challenge title
    cout << "Hex Input: " << input << endl;                 //original hex input
    cout << "\nBase64 Output: " << b64Output << endl;       //base 64 output
}
